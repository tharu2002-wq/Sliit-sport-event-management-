 ...
 */
export function PlayerPicker({ players, selectedIds, onChange, disabled }) {
  ...
  return (
    <div className="rounded-xl border border-gray-200 bg-white">
      <div className="max-h-56 overflow-y-auto p-2">
        {players.length === 0 ? (
          <p className="px-2 py-3 text-sm text-gray-500">No players in the system yet. Create players first.</p>
        ) : (
