...
router.get("/", protect, authorizeRoles("admin"), listTeamRequests);
router.patch("/:id/accept", protect, authorizeRoles("admin"), acceptTeamRequest);
router.patch("/:id/reject", protect, authorizeRoles("admin"), rejectTeamRequest);
